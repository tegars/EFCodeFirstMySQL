using EFCodeFirstMySQL.EntityFramework.Entities;
...
namespace EFCodeFirstMySQL.EntityFramework
{
    public class DBContext : DbContext
    {
        ...
        {
            optionsBuilder.UseMySql(@"server=localhost;database=FirstEF;user=root;password=fads");
        }
